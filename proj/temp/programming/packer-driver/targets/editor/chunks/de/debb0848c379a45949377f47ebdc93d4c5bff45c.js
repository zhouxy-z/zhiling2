  ...
  return {
    ...
    execute: function () {
      ...
      _export("MailPanel", MailPanel = class MailPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onRefershItem() {
          if (this.seleteIndex != 3) {
            let getmails = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
              error: Error()
            ...
            let getitem = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
              error: Error()
        ...
        async updateMailItem(item, data) {
          ...
          mask.active = false;
          let url = path.join(_crd && folder_mail === void 0 ? (_reportPossibleCrUseOffolder_mail({
            error: Error()
          ...
          mailIcon.spriteFrame = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
        ...
        onSelect(id) {
          let info = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        updateMailContent(data) {
          ...
          let mail_content = this.MailContent.getComponent(_crd && MailContent === void 0 ? (_reportPossibleCrUseOfMailContent({
            error: Error()
        ...
        onDeleteAll() {
          let delet_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        onClaimAll() {
          let get_mail = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        onSendGift() {
          ...
          let mail_send_panel = this.MailSendContent.getComponent(_crd && MailSendContent === void 0 ? (_reportPossibleCrUseOfMailSendContent({
            error: Error()
          }), MailSendContent) : MailSendContent);
        ...
        async updateMailLogItem(item, data) {
          ...
          let datetime = (_crd && DateUtils === void 0 ? (_reportPossibleCrUseOfDateUtils({
            error: Error()
          ...
          let cfg_item = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).Getitem(data.itemId);
          let rate = cfg_item.Itemtpye == (_crd && ItemType === void 0 ? (_reportPossibleCrUseOfItemType({
            error: Error()
          ...
          is_get.spriteFrame = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
          }), ResMgr) : ResMgr).LoadResAbSub(path.join("sheets/mails", icon_name, "spriteFrame"), SpriteFrame);
          let itemData = (_crd && ItemUtil === void 0 ? (_reportPossibleCrUseOfItemUtil({
            error: Error()
          ...
          let bagItem = bag_item.getComponent(_crd && BagItem === void 0 ? (_reportPossibleCrUseOfBagItem({
            error: Error()
          }), BagItem) : BagItem);
