  ...
  return {
    ...
    execute: function () {
      ...
      _export("MailModule", MailModule = class MailModule {
        ...
        onMailPush(data) {
          let pushData = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onReadMailList(data) {
          let data_list = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
          ...
          if (data_list.mails && data_list.mails.length > 0) {
            for (let mail of data_list.mails) {
              if (!(_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                ...
                let curMail = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                  error: Error()
        ...
        onReadMail(data) {
          let read_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onClaimMailAttachments(data) {
          let get_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        updateMailsData(mail_data, type) {
          for (let i = 0; i < (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            ...
            let mail = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
        ...
        onDeleteMail(data) {
          ...
          if (delete_data.deletedMailIds.length > 0) {
            for (let i = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
        ...
        onClaimAllMailAttachments(data) {
          let gets_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onPlayerInfo(data) {
          let player_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onSendCurrency(data) {
          let send_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
          }), Ret) : Ret)["logic.protocol.sendgivemail"].decode(data);
          console.log(send_data);

          if (send_data.res.code == 1107) {
            let setpassword = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
              error: Error()
        ...
        ongetitemrecords(data) {
          let info_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
