    ...
    execute: function () {
      ...
      _export("MainPanel", MainPanel = class MainPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        async startTween() {
          ...
          for (let index = 0; index < this.currencyNode.children.length; index++) {
            const element = this.currencyNode.children[index];
            tween(element.getChildByName("icon")).to(0.3, {
              scale: new Vec3(1, 1, 1)
            }).start();
            tween(element.getChildByName("Label").getComponent(UIOpacity)).to(0.3, {
              opacity: 255
            }).start();
          ...
          tween(this.userButton.node.getComponent(UIOpacity)).to(0.05, {
            opacity: 255
          }).start();
        ...
        async setCardGroupItem() {
          ...
          if ((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            ...
            let card_group = this.cardGoup.getComponent(_crd && CardGroupItem === void 0 ? (_reportPossibleCrUseOfCardGroupItem({
              error: Error()
            }), CardGroupItem) : CardGroupItem);
            if (!card_group) this.cardGoup.addComponent(_crd && CardGroupItem === void 0 ? (_reportPossibleCrUseOfCardGroupItem({
              error: Error()
            }), CardGroupItem) : CardGroupItem);
            card_group.SetData((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).CurFightCardGroup, true);
            this.head.SetData((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
        ...
        checkShowSeasonTips() {
          ...
          let key = `season_tips_is_show_${(_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).player.playerId}`;
          let showSeasonTipsDatas = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
