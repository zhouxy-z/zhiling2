  ...
  return {
    ...
    execute: function () {
      ...
      _export("SignPanel", SignPanel = class SignPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(index) {
          let task_all_data = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          ...
          for (let index = 1; index <= 7; index++) {
            ...
            for (const iterator of task_Data) {
              if (iterator.id == id) {
                let data = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                  error: Error()
          ...
          for (let index = 0; index < this.reward_data[6].length; index++) {
            ...
            item.getChildByName("sign").active = this.taskData[6].s == (_crd && STaskState === void 0 ? (_reportPossibleCrUseOfSTaskState({
              error: Error()
            }), STaskState) : STaskState).Finsh;
            let bagItem = item.getComponent(_crd && BagItem === void 0 ? (_reportPossibleCrUseOfBagItem({
              error: Error()
