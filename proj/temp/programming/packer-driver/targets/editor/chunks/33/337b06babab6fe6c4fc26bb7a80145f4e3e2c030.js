    ...
    execute: function () {
      ...
      _export("TradePanel", TradePanel = class TradePanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        SendOrderType() {
          ...
          let item_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
          ...
          let card_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        SendBuyOrSellType(searchCardData) {
          if (this.select_thing_type == (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
            ...
            (_crd && Session === void 0 ? (_reportPossibleCrUseOfSession({
              ...
              error: Error()
            }), Route) : Route)["market.protocol.searchcardorders"], data);
          }
        }
        /** 在上架管理中代表订单种类 （头顶小页签）*/
        ...
        updateItem(item, data, index) {
          let itemScropt = item.getComponent(_crd && TradePanelItem === void 0 ? (_reportPossibleCrUseOfTradePanelItem({
            error: Error()
        ...
        initSortListData() {
          ...
          for (let index = 0; index < all_tag_name.length; index++) {
            let bourseData = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
        ...
        openOneTag(e) {
          ...
          content.removeAllChildren();
          let bourseData = item["bourseData"]; //根据物品的类别细分到不同的组

          let group_id = [];
          let group_list_data = []; //一级页签下未分组的物品 加到最后
        ...
        setectItemName(e) {
          ...
          if (type == 0) {
            //道具
            let bourseData = item["bourseData3"]; //筛选道具
            ...
            //卡牌
            let bourseData = item["bourseData3"];
            this.groupType = null;
