  ...
  return {
    ...
    execute: function () {
      ...
      _export("FriendIncomeListPanel", FriendIncomeListPanel = class FriendIncomeListPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        async flush(income = 0) {// this.incomeNum.string = ToFixed(income, 4) + "";
        }

        async updateItem(item, data, index) {// let headItem:HeadItem = item.getChildByPath("frame/HeadItem").addComponent(HeadItem);
