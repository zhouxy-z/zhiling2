    ...
    execute: function () {
      ...
      _export("Card", Card = class Card extends Component {
        ...
        async SetData(data) {
          ...
          if (std.EthnicType) {
            this.camp.spriteFrame = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
          ...
          if (std.ProfessionType) {
            this.job.spriteFrame = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).LoadResAbSub(path.join(_crd && folder_icon === void 0 ? (_reportPossibleCrUseOffolder_icon({
              error: Error()
