System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, tween, UITransform, v3, BattleBaseComp, battleDataMgr, battleLogicMgr, BattleCard, Out_HandToTerrain, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c4fa1r4HzRDI6VvVUIj+k/w", "Out_HandToTerrain", undefined);
      ...
      _export("Out_HandToTerrain", Out_HandToTerrain = class Out_HandToTerrain extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        toShow() {
          if ((_crd && battleDataMgr === void 0 ? (_reportPossibleCrUseOfbattleDataMgr({
            ...
            for (let area of (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
              error: Error()
            ...
            let startPos = layerTrans.convertToWorldSpaceAR(v3(layerTrans.width * 0.5, layerTrans.height * 0.5, 0));
            let targetPos;
            let terrainData = (_crd && battleDataMgr === void 0 ? (_reportPossibleCrUseOfbattleDataMgr({
              error: Error()
            }), battleDataMgr) : battleDataMgr).getPlayerTerrain(this.data.toTerrainPlayerId, this.data.toTerrainInstId);
            let isCheck = false;
            ...
            let card = (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
              error: Error()
            }), battleLogicMgr) : battleLogicMgr).fromPoolCard;
            let cardComp = card.getComponent(_crd && BattleCard === void 0 ? (_reportPossibleCrUseOfBattleCard({
              error: Error()
...
//# sourceMappingURL=924621d5424ffe655295f33553b9d25b5faf5013.js.map