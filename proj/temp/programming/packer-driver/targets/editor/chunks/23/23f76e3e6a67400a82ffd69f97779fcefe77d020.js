    ...
    execute: function () {
      ...
      _export("BattleModule", BattleModule = class BattleModule {
        ...
        onBattleSettlement(roomId, playerAId, data) {
          let isGiveUp = data.leavePlayerId != null || data.leavePlayerId != "";
        ...
        onPlayerDataInit() {
          //获取有效战斗房间摘要
          let room = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        onCreatRoomResult(data) {
          let room = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        async onCreatebattlereplayroom(data) {
          let result = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        async onGetlastbattleroomsummary(data) {
          let result = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        async enterRoom(isVs = false) {
          ...
          (_crd && FightUI === void 0 ? (_reportPossibleCrUseOfFightUI({
            error: Error()
          }), FightUI) : FightUI).ShowUI(this.curRoom);
          ...
          if (isVs) await (_crd && Second === void 0 ? (_reportPossibleCrUseOfSecond({
            error: Error()
          }), Second) : Second)(2);
          (_crd && GameSet === void 0 ? (_reportPossibleCrUseOfGameSet({
            error: Error()
