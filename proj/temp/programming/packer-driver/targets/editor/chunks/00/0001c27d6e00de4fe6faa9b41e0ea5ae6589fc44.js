    ...
    execute: function () {
      ...
      _export("ShopCommPage", ShopCommPage = class ShopCommPage extends (_crd && ShopBasePage === void 0 ? (_reportPossibleCrUseOfShopBasePage({
        ...
        UpdateShow() {
          ...
          let stdShop = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          ...
          if (this.shopData) {
            let lists = this.shopData.shopItems;
            adItemList = this.shopData.adShopItems ? this.shopData.adShopItems.concat() : [];

            for (let index = 0; index < lists.length; index++) {
              let shopItem = lists[index];
              let std_s = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
        ...
        updateOnShow() {
          let opacity = this.titleImg.node.getComponent(UIOpacity);
        ...
        updateShopItem(item, data, index) {
          let shopItem = item.getComponent(_crd && ShopCommItem === void 0 ? (_reportPossibleCrUseOfShopCommItem({
            error: Error()
        ...
        async onShopSelect(index, item) {
          let shopData = this.shopDatas[index]; // let std = CfgMgr.GetCommShopItem(shopData.id);
          ...
          (_crd && ShopBuyPanel === void 0 ? (_reportPossibleCrUseOfShopBuyPanel({
            error: Error()
          }), ShopBuyPanel) : ShopBuyPanel).Show(this.shopId, shopData); // }
        }
