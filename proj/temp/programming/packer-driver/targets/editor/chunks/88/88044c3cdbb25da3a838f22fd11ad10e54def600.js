    ...
    execute: function () {
      ...
      _export("CardsPanelTest", CardsPanelTest = class CardsPanelTest extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateCardItem(cell, cellInfo) {
          let card = cell.getChildByName("CardsTest").getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
        ...
        updateCardGroupCardItem(item, data, index) {
          let card = item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
        ...
        onSelectCard(cell, cellInfo, lastCell, lastInfo) {
          let cards = cell.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
        ...
        setCardGary(data, is_gray) {
          ...
          for (const iterator of this.Content.children) {
            let item = iterator.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest);
        ...
        onSelectCardGroupCard(index, item) {
          let cards = item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
        ...
        setCardState(data, is_select = null, isUpdate, isDle) {
          ...
          for (let index = 0; index < content.length; index++) {
            ...
            let card = element.getChildByName("CardsTest").getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest);
