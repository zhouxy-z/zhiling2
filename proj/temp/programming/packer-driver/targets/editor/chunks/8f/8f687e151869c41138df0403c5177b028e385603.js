    ...
    execute: function () {
      ...
      _export("VirtualListExample", VirtualListExample = (_dec = ccclass('VirtualListExample'), _dec2 = property({
        ...
        start() {
          ...
          let vList = this.listNode.getChildByPath("vList").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          ...
          let vListPage = this.listNode.getChildByPath("vListPage").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          ...
          let vGrid = this.listNode.getChildByPath("vGrid").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          ...
          let vPullHead = this.listNode.getChildByPath("vPullHead").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          let vPullHeadNode = this.listNode.getChildByPath("vPullHead").getChildByPath("view/head");
          ...
          let vPullFooter = this.listNode.getChildByPath("vPullFooter").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          let vPullFooterNode = this.listNode.getChildByPath("vPullFooter").getChildByPath("view/footer");
          ...
          let nestVHList = this.listNode.getChildByPath("nestVHList").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          ...
          nestVHList.updateCell = (cell, cellInfo) => {
            cell.getChildByName("indexLab").getComponent(Label).string = cellInfo.index + "";
            cell.getChildByName("select").active = cellInfo.isSelect;
            let subList = cell.getChildByName("subList").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
              error: Error()
            }), VList) : VList);
          ...
          let multList = this.listNode.getChildByPath("multList").getComponent(_crd && VList === void 0 ? (_reportPossibleCrUseOfVList({
            error: Error()
          }), VList) : VList);
          ...
          multList.getCellSize = (cell, index) => {
            ...
            let num = Math.floor(Math.random() * (max - min + 1)) + min;
            let cellSize = new Size(640, 160 + num);
            return cellSize;
          };
        }
        ...
        onBtnClick(btn) {
          ...
          let curPanel = this.listNode.children[showIndex];
