    ...
    execute: function () {
      ...
      _export("ShopModule", ShopModule = class ShopModule {
        ...
        onShopGetIndexRet(data) {
          let shop_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onShopBuyItemRet(data) {
          let shop_buy_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        onShopDoLotteryRet(data) {
          let luck_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        showErrorCode(code) {
          let errorStr = this.errorStr[code];
