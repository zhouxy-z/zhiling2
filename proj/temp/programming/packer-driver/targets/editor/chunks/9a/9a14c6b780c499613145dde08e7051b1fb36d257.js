  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardGroupCreatorTips", CardGroupCreatorTips = class CardGroupCreatorTips extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        async flush(select_id, card_list, callback1, callback2) {
          this.callBack1 = callback1;
          this.callBack2 = callback2;
          let select_cfg = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
        ...
        updateScorll() {
          let name = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        updateCardItem(item, data) {
          let card = item.getChildByName("Cards").getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
            error: Error()
          }), Card) : Card);
