  ...
  return {
    ...
    execute: function () {
      ...
      _export("UserInfoPanel", UserInfoPanel = class UserInfoPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onHide(...args) {// EventMgr.off(Evt_PlayerBaseInfoChange, this.onUserDataChange, this);
        }
        ...
        updateView() {
          ...
          if (this.isOwn) {
            ...
            let myWeChat = this._playerData.contactWechat || "";
            let myQQ = this._playerData.contactQq || "";
