  ...
  return {
    ...
    execute: function () {
      ...
      _export("ClickTipsPanel", ClickTipsPanel = class ClickTipsPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(target, targetPatent, clickTarget, showWorlPos = null, dir = 0, hideCb) {
        ...
        resetTarger() {
          if (this.tipsCont.children.length > 0) {
            let target = this.tipsCont.children[0];
        ...
        onTouchMove(touch) {
          ...
          this.dis.x += dis.x;
          this.dis.y += dis.y;
          let distance = this.dis.length(); //滑动区域20像素算作移动
