  ...
  return {
    ...
    execute: function () {
      ...
      _export("FriendSharePanel", FriendSharePanel = class FriendSharePanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onLoad() {
          //25328825
          let url = "http://test.daochat.cn?inviteCode=" + (_crd && GetInviteCode === void 0 ? (_reportPossibleCrUseOfGetInviteCode({
            error: Error()
          }), GetInviteCode) : GetInviteCode)() + "&appId=test";
          let qrcode = (_crd && QrcodeMaker === void 0 ? (_reportPossibleCrUseOfQrcodeMaker({
            error: Error()
        ...
        async flush() {
          this.name_str.string = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).roleInfo.name;
          this.uid_str.string = "ID:" + (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).roleInfo.player_id; // this.sever_str.string = "";

          let url = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
