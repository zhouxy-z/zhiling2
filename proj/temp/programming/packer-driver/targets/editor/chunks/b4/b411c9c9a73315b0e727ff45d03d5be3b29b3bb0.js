    ...
    execute: function () {
      ...
      _export("MailSendContent", MailSendContent = class MailSendContent extends Component {
        ...
        async onShow(data, close_back) {
          ...
          let list_item_data = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        updateItemInfo() {
          ...
          let bag_item = this.item.getComponent(_crd && BagItem === void 0 ? (_reportPossibleCrUseOfBagItem({
            error: Error()
          }), BagItem) : BagItem);
        ...
        onShowSurePanel() {
          ...
          let cost_item_num = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).GetItemCount(this.cfg_item.FeeItemID);
          let name = this.itemData.ItemName; // if(!PlayerData.roleInfo.is_password){
