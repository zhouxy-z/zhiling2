  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", LocalStorage = class LocalStorage {
        ...
        static GetBool(cusKey, cusDefault = false) {
          var _ref2;

          const _value = sys.localStorage.getItem(this.gameName + ((_ref2 = _crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        static GetNumber(cusKey, cusDefault = 0) {
          var _ref4;

          const _value = sys.localStorage.getItem(this.gameName + ((_ref4 = _crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        static GetString(cusKey, def = "") {
          ...
          const _value = sys.localStorage.getItem(this.gameName + ((_ref6 = _crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        static GetObject(cusKey, cusDefault = null) {
          var _ref8;

          const _value = sys.localStorage.getItem(this.gameName + ((_ref8 = _crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
