System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  _export("VSSectionAwardItem", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "27cddaUdj9D96HcE6pdqZXn", "VSSectionAwardItem", undefined);

      __checkObsolete__(['Node', 'Component', 'Button', 'Sprite', 'Label', 'path', 'SpriteFrame', 'Layout', 'UITransform', 'UIOpacity']);

      _export("VSSectionAwardItem", VSSectionAwardItem = class VSSectionAwardItem extends Component {
        constructor(...args) {
          super(...args);
        ...
        onBtnClick(btn) {
          let seasonData = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        updateStar() {
          ...
          if (this.stdPvpLevel.Star > 1) {
            ...
            let starNum = this.stdPvpLevel.Star - 1;
            let node;
            let updateSize = [];
            let point = 0;
            ...
            for (let node of updateSize) {
              ...
              let bg = node.getChildByName("lineBg");
...
//# sourceMappingURL=31b6003fb62db18e5d9ae3586c1b27d221f56188.js.map