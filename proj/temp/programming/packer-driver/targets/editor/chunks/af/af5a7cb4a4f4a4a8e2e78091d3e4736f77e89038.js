    ...
    execute: function () {
      ...
      _export("VSPanel", VSPanel = class VSPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        playStartVsEffect() {
          ...
          let itemW = this.VsPlayerItemA.node.getComponent(UITransform).width;
          let totalW = this.node.getComponent(UITransform).width;
          let offsetX = totalW * 0.5 + itemW * 0.5;
        ...
        sendStartVs() {
          ...
          let startBattle = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        shoVsInfo(curRoom) {
          let playerDataB = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          for (let key in curRoom.players) {
            let playerData = curRoom.players[key];
