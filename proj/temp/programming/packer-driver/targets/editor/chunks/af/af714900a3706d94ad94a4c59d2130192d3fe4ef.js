      ...
      _export("CardCollectLvContItem", CardCollectLvContItem = class CardCollectLvContItem extends Component {
        ...
        updateLine() {
          if (this.data.sectionList != null) {
            ...
            let lineNum = this.data.sectionList.length + 1;
            let node;
            let updateSize = [];
            ...
            for (let index = 0; index < this.lineCont.children.length; index++) {
              ...
              if (index < lineNum) {
                ...
                let targetLv = this.data.stdPlayerLevel.Level + (index + 1);
        ...
        updateLv() {
          ...
          let lvStr = this.data.stdPlayerLevel.Level.toString();
