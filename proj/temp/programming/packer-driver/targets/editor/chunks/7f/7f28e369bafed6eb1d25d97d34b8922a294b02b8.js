    ...
    execute: function () {
      ...
      _export("SeasonFightLogPanel", SeasonFightLogPanel = class SeasonFightLogPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateCellLog(cell, cellInfo) {
          ...
          let logItem = cell.getComponent(_crd && SectionBattleLogItem === void 0 ? (_reportPossibleCrUseOfSectionBattleLogItem({
            error: Error()
        ...
        updateCellCardA(cell, cellInfo) {
          ...
          let logCardItem = cell.getComponent(_crd && SeasonFightLogCardItem === void 0 ? (_reportPossibleCrUseOfSeasonFightLogCardItem({
            error: Error()
