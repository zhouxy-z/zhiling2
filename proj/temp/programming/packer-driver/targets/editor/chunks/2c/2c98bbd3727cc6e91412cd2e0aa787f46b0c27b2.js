    ...
    execute: function () {
      ...
      _export("CardsGroupSetting", CardsGroupSetting = class CardsGroupSetting extends Component {
        ...
        setHeadList(data_list) {
          let data = data_list ? data_list : (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        updateHeadItem(item, data) {
          let head = item.getComponent(_crd && CardGroupHead === void 0 ? (_reportPossibleCrUseOfCardGroupHead({
            error: Error()
          }), CardGroupHead) : CardGroupHead);
          if (!head) head = item.addComponent(_crd && CardGroupHead === void 0 ? (_reportPossibleCrUseOfCardGroupHead({
            error: Error()
          }), CardGroupHead) : CardGroupHead);
          let is_use = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
        ...
        updateCardBackItem(item, data) {
          ...
          let icon_spr = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
        ...
        setRightData() {
          ...
          if (data) {
            ...
            for (const key in (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).cardHeadList) {
              const element = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                error: Error()
              }), PlayerData) : PlayerData).cardHeadList[key];
        ...
        setSort() {
          ...
          if (this.tag2 == 0) {
            ...
            for (let index = 0; index < lsit.length; index++) {
              ...
              data_list.push((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                error: Error()
              }), PlayerData) : PlayerData).cardBackList[element]);
            }
        ...
        setFiltrate() {
          ...
          if (this.tag2 == 0) {
            let data_list = {};
            let list = Object.keys((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).cardHeadList);
            ...
            for (let index = 0; index < list.length; index++) {
              ...
              if (is_select) {
                if ((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                  error: Error()
                }), PlayerData) : PlayerData).cardBackList[element].like) {
                  data_list[element] = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                    error: Error()
                  }), PlayerData) : PlayerData).cardBackList[element];
                }
