      ...
      _export("SeasonPanel", SeasonPanel = class SeasonPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onBtnClick(btn) {
          switch (btn) {
            ...
            case this.addBtn:
              let num1 = this.seasonData.currentRankInfo.rankPoints + 1;
              this.seasonData.currentRankInfo.rankPoints = num1;
              this.updateSection();
              break;

            case this.subBtn:
              let num2 = this.seasonData.currentRankInfo.rankPoints - 1;
        ...
        updateSection() {
          ...
          let point = Math.max(this.seasonData.currentRankInfo.rankPoints - this.curStdPvpLv.LevelPoints, 0);
          ...
          if (this.curStdPvpLv.Star == 1) {
            ...
            let bright = starNode.getChildByName("bright");
          ...
          let curExp = point % this.curStdPvpLv.StarPoints;
          let mapExp = this.curStdPvpLv.StarPoints;
        ...
        cardGroupClick(cell, cellInfo) {
          let cardGroupData = this.cardGroupDataList[cellInfo.index];
        ...
        updateCardGroupCell(cell, cellInfo) {
          let cellCom = cell.getComponent(_crd && SeasonCardGruopItem === void 0 ? (_reportPossibleCrUseOfSeasonCardGruopItem({
            error: Error()
