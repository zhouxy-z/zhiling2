      ...
      _export("TradePanelItem", TradePanelItem = (_dec = ccclass('TradePanelItem'), _dec(_class = class TradePanelItem extends Component {
        ...
        SetData(_data, selectType, select_thing_type) {
          ...
          if (select_thing_type == (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
            ...
            let item_data = bagItem.getComponent(_crd && BagItem === void 0 ? (_reportPossibleCrUseOfBagItem({
              error: Error()
            }), BagItem) : BagItem);
            ...
            let itemCfg = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            ...
            let data = _data;
            if (!data) return;
            num = data.status == (_crd && OrderStateType === void 0 ? (_reportPossibleCrUseOfOrderStateType({
              error: Error()
            }), OrderStateType) : OrderStateType).active ? 1 : 0; //只有激活状态可以购买

            let card_data = cardItem.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card);
          ...
          let btnspr = _data.makerId == (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          ...
          let labelcolorValue = _data.makerId == (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          ...
          count.string = `${num}`;
          let item_icon = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
        ...
        SetOrderData(_data, selectType) {
          ...
          if (_data) {
            ...
            if (order_type == (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
              ...
              let cardCfg = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
            ...
            removeBtn.on(Input.EventType.TOUCH_END, () => {
              if (order_type == (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
                ...
                let sessionData = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
                  error: Error()
                ...
                let cancelcardData = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
                  error: Error()
        ...
        async setPayItemIcon(_data, msgNode) {
          let item_icon = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).Getitem(_data.currency).Icon;
          let spr_icon = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
          }), ResMgr) : ResMgr).LoadResAbSub(path.join(_crd && folder_item === void 0 ? (_reportPossibleCrUseOffolder_item({
            error: Error()
