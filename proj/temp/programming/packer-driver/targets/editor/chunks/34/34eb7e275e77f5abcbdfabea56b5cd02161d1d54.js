System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, tween, v3, BattleBaseComp, battleDataMgr, battleLogicMgr, Out_CardTerrainState_2d, _crd;
  ...
  _export("Out_CardTerrainState_2d", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "89323sRsUpKtKJdtSkDQFWX", "Out_CardTerrainState_2d", undefined);
       ...
       * 卡牌在地形上的状态改变（由盖牌到显示）
       */
      _export("Out_CardTerrainState_2d", Out_CardTerrainState_2d = class Out_CardTerrainState_2d extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        error: Error()
        ...
        toShow() {
          let terraninAreaList = (_crd && battleDataMgr === void 0 ? (_reportPossibleCrUseOfbattleDataMgr({
            error: Error()
...
//# sourceMappingURL=34eb7e275e77f5abcbdfabea56b5cd02161d1d54.js.map