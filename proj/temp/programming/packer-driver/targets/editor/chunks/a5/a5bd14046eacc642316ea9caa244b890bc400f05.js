    ...
    execute: function () {
      ...
      _export("ShopBuyPanel", ShopBuyPanel = class ShopBuyPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(shopId, shopData) {
          ...
          let priceItem = (_crd && ItemUtil === void 0 ? (_reportPossibleCrUseOfItemUtil({
            error: Error()
          }), ItemUtil) : ItemUtil).CreateThing((_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
            error: Error()
        ...
        onSlide(event) {
          let tempNum = Math.ceil(event.progress * this.maxNum);
        ...
        updateItemCount() {
          ...
          let num = this.curNum * this.std.CostNumber[0];
          ...
          for (let index = 0; index < this.std.CostID.length; index++) {
            const type = (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
              error: Error()
          ...
          let isCanBuy = this.curNum > 0 && (_crd && ItemUtil === void 0 ? (_reportPossibleCrUseOfItemUtil({
            error: Error()
