      ...
      _export("BagItem1", BagItem1 = class BagItem1 extends Component {
        ...
        async setItem(data) {
          if (data.type == (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
            ...
            this.newIcon.active = false; // data.isNew = false;
            ...
            if (std.Itemtpye == (_crd && ItemType === void 0 ? (_reportPossibleCrUseOfItemType({
              ...
              this.num.string = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
            ...
            let isHaveRedPoint = false; // if (this.showRedPoint) {
            ...
            this.node.getComponent(Toggle).enabled = this.showSelect;
            this.node.name = std.CardName + ""; // this.icon.spriteFrame = await ResMgr.LoadResAbSub(path.join(folder_item, std.Icon, "spriteFrame"), SpriteFrame);
