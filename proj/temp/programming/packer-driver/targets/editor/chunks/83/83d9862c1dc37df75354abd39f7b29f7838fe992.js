  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShopDefinePage", ShopDefinePage = class ShopDefinePage extends (_crd && AsyncComponent === void 0 ? (_reportPossibleCrUseOfAsyncComponent({
        ...
        sort(a, b) {
          let aseed = (a.count < 0 ? 1 : 0) * 10000 + (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).GetCommShopItem(a.id).Order;
          let bseed = (b.count < 0 ? 1 : 0) * 10000 + (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
        ...
        update(dt) {
          ...
          if (this.refreshShop) {
            ...
            let residueTime = Math.max(Math.floor(this.refreshShop.shop.refreshTime - (_crd && DateUtils === void 0 ? (_reportPossibleCrUseOfDateUtils({
              error: Error()
        ...
        updateItem(item, data, index) {
          let shopItem = item.getComponent(_crd && ShopItem === void 0 ? (_reportPossibleCrUseOfShopItem({
            error: Error()
          }), ShopItem) : ShopItem);
        ...
        async updateProgress() {
          ...
          let url = path.join(_crd && folder_item === void 0 ? (_reportPossibleCrUseOffolder_item({
            ...
            error: Error()
          }), CfgMgr) : CfgMgr).Getitem(this.costCfg.CostID[0]).Icon, "spriteFrame");
          this.costIcon.spriteFrame = await (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
        ...
        onBuy() {
          ...
          let buy_item = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
