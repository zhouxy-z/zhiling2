  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoomPanel", RoomPanel = class RoomPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onLoad() {
          this.areaList = [];
          let temoAreaList = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          ...
          this.stdCardList = [];
          let tempCardList = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          ...
          let defAiId = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
          }), LocalStorage) : LocalStorage).GetNumber("test_ai", undefined);

          if (defAiId) {
            let tepmAiId = undefined;

            for (let index = 0; index < (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).AIGroupList.length; index++) {
              let aiGrop = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
          ...
          let areas = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
          }), LocalStorage) : LocalStorage).GetString("test_area", undefined);

          if (areas) {
            let tepmAreasIds = [];
            let localData = JSON.parse(areas);

            for (let index = 0; index < localData.length; index++) {
              let areaId = localData[index];
              let stdArea = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
          ...
          let ads = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
          }), LocalStorage) : LocalStorage).GetString("test_ads", undefined);

          if (ads) {
            let tepmAdCardIds = [];
            let localData = JSON.parse(ads);
          ...
          let mys = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
          }), LocalStorage) : LocalStorage).GetString("test_mys", undefined);

          if (mys) {
            let tepmMyCardIds = [];
            let localData = JSON.parse(mys);
          ...
          this.terrainList.updateCell = (cell, cellInfo) => {
            let std = this.areaList[cellInfo.index];
            ...
            for (let index = 0; index < std.AreaAffect.length; index++) {
              let skill = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
              }), CfgMgr) : CfgMgr).GetCardSkill(std.AreaAffect[index]);
          ...
          this.aiIdList.updateCell = (cell, cellInfo) => {
            let std = this.aiList[cellInfo.index];
          ...
          this.cardList.updateCell = (cell, cellInfo) => {
            let std = this.curCardList[cellInfo.index];
            ...
            for (let index = 0; index < std.SkillID.length; index++) {
              let skill = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
              }), CfgMgr) : CfgMgr).GetCardSkill(std.SkillID[index]);
            ...
            let body = cell.getChildByPath("body_card").getComponent(sp.Skeleton);
          ...
          this.cardList.clickCell = (cell, cellInfo) => {
            let list = this.setCardType == 1 ? this.defAiCardId : this.defMyCardId;
            ...
            let addCard = this.curCardList[cellInfo.index];
        ...
        selectAiId(index) {
          ...
          let std = this.aiList[this.selectAiIndx];
        ...
        onBtnClick(btn) {
          switch (btn) {
            ...
            case this.seekBtn:
              ...
              let seekStr = this.seekLab.string;
        ...
        onCreatRoom() {
          if (!(_crd && battleDataMgr === void 0 ? (_reportPossibleCrUseOfbattleDataMgr({
            ...
            let enterRoom = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
              error: Error()
