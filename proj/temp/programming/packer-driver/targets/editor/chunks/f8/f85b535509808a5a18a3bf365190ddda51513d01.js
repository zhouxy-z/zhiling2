    ...
    execute: function () {
      ...
      _export("BattleLogicMgr", BattleLogicMgr = class BattleLogicMgr {
        ...
        init(root) {
          ...
          let terraninAreaContB = root.getChildByName("terraninAreaContB");
          loop = 0;

          for (let node of terraninAreaContB.children) {
            let com = node.addComponent(_crd && BattleTerrainArea === void 0 ? (_reportPossibleCrUseOfBattleTerrainArea({
              error: Error()
          ...
          let terrainCont = root.getChildByName("terrainCont");
          loop = 0;

          for (let node of terrainCont.children) {
            let com = node.addComponent(_crd && BattleTerrainGrid === void 0 ? (_reportPossibleCrUseOfBattleTerrainGrid({
              error: Error()
          ...
          let terraninAreaContA = root.getChildByName("terraninAreaContA");
          loop = 0;
          ...
          for (let node of this.handGridCont.children) {
            let com = node.addComponent(_crd && BattleCardGrid === void 0 ? (_reportPossibleCrUseOfBattleCardGrid({
              error: Error()
        ...
        runBattle() {
          ...
          if (battleOpData) {
            this.isRun = true;
            let comp = (_crd && battleCompMgr === void 0 ? (_reportPossibleCrUseOfbattleCompMgr({
              error: Error()
