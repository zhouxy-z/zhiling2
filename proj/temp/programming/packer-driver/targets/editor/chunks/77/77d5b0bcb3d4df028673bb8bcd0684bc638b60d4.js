    ...
    execute: function () {
      ...
      _export("UserHeadPanel", UserHeadPanel = class UserHeadPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateHeadItem(item, data) {
          let headItem = item.getComponent(_crd && UserHeadItem === void 0 ? (_reportPossibleCrUseOfUserHeadItem({
            error: Error()
        ...
        updateSelect(stdHead) {
          ...
          let headUrl; // if(stdHead.HeadType == StdHeadType.Head){
        ...
        resetSelect() {
          let children = this.headList.node.getChildByPath("view/content").children;
