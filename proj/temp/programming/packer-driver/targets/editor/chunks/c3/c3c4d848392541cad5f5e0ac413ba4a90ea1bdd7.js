System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, tween, UITransform, v3, BattleBaseComp, battleLogicMgr, BattleCard, battleDataMgr, Out_CardDeckFrontToHandTail, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "82372PUralGwY109NlK8ca1", "Out_CardDeckFrontToHandTail", undefined);
      ...
      _export("Out_CardDeckFrontToHandTail", Out_CardDeckFrontToHandTail = class Out_CardDeckFrontToHandTail extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        creatCard() {
          let data = this.data.cards.shift();
          ...
          let layerTrans = cardCom.node.parent.getComponent(UITransform);
          let startPos = layerTrans.convertToWorldSpaceAR(cardCom.node.getPosition());
          cardCom.node.worldPosition = startPos;
          let targetPos; //第一视觉补牌
...
//# sourceMappingURL=c3c4d848392541cad5f5e0ac413ba4a90ea1bdd7.js.map