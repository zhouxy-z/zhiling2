    ...
    execute: function () {
      ...
      _export("Tips2", Tips2 = class Tips2 extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(id) {
          ...
          let listUi = this.ScrollView.getComponent(UITransform);
          let labH = this.label.node.getComponent(UITransform).height;
          listUi.height = labH >= this.scroll_max_height ? this.scroll_max_height : labH;
          let view = this.find("frame/ScrollView/view");
          let viewWidget = view.getComponent(Widget);
