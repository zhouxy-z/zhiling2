    ...
    execute: function () {
      ...
      _export("SeasonActiveTaskCont", SeasonActiveTaskCont = class SeasonActiveTaskCont extends Component {
        ...
        updateShow() {
          ...
          var url = "sheets/task/seasonBox/spriteFrame";
        ...
        onBtnClick() {
          ...
          if (task_state == 2) {
            ...
            var tipsW = 382;
            var itemPos = this.boxItemTemp.worldPosition.clone();
            var showPos;
            var offset = tipsW / 2 + itemPos.x;
        ...
        update(dt) {
          ...
          var time = endTime - (_crd && DateUtils === void 0 ? (_reportPossibleCrUseOfDateUtils({
            error: Error()
          }), DateUtils) : DateUtils).ServerTime;
