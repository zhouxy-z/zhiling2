      ...
      _export("ComposePanel", ComposePanel = (_dec = (_crd && CLICKLOCK === void 0 ? (_reportPossibleCrUseOfCLICKLOCK({
        ...
        flush(ItemID) {
          ...
          return _asyncToGenerator(function* () {
            _this.Item = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).Getitem(ItemID);

            if (!_this.Item || _this.Item.SubType != (_crd && ItemSubType === void 0 ? (_reportPossibleCrUseOfItemSubType({
              error: Error()
            ...
            _this.level.string = "Lv.1";

            var role = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).GetRole()[_this.Item.ItemEffect1];

            var prefab = role.Prefab;
            var scale = role.Scale || 1;

            _this.body.node.setScale(0.3 * scale, 0.3 * scale);

            _this.body.skeletonData = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).LoadResAbSub(path.join("spine/role", prefab, prefab), sp.SkeletonData);

            _this.body.setAnimation(0, "Idle", true);

            _this.targetName.string = "" + role.Name;
            var url = path.join((_crd && folder_icon === void 0 ? (_reportPossibleCrUseOffolder_icon({
              error: Error()
            }), folder_icon) : folder_icon) + "quality", (_crd && CardQuality === void 0 ? (_reportPossibleCrUseOfCardQuality({
              error: Error()
            }), CardQuality) : CardQuality)[_this.Item.ItemEffect2], "spriteFrame");
            _this.quality.spriteFrame = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).LoadResAbSub(url, SpriteFrame);
            _this.jobIcon.spriteFrame = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            ...
            _this.jobName.string = "" + (_crd && JobName === void 0 ? (_reportPossibleCrUseOfJobName({
              error: Error()
            }), JobName) : JobName)[role.PositionType]; //let oldPower:number = CountPower(role.RoleType, 1);

            var newPower = (_crd && RoleCardPower === void 0 ? (_reportPossibleCrUseOfRoleCardPower({
              error: Error()
            }), RoleCardPower) : RoleCardPower)(role.RoleType, _this.Item.ItemEffect2);
            _this.power.string = (_crd && formatNumber === void 0 ? (_reportPossibleCrUseOfformatNumber({
              error: Error()
            }), formatNumber) : formatNumber)(newPower, 2);
            _this.count.string = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).GetItemCount(ItemID) + "/" + _this.Item.ItemEffect3;
            (_crd && SetLabelColor === void 0 ? (_reportPossibleCrUseOfSetLabelColor({
              error: Error()
            }), SetLabelColor) : SetLabelColor)(_this.count, (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).GetItemCount(ItemID), _this.Item.ItemEffect3);
            _this.composeBtn.getComponent(Sprite).grayscale = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).GetItemCount(_this.Item.Items) < _this.Item.ItemEffect3;
            _this.icon.spriteFrame = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              ...
              error: Error()
            }), folder_item) : folder_item, _this.Item.Icon, "spriteFrame"), SpriteFrame);
            _this.collectAttrCont.active = false;
            var attrList = (_crd && FormatCardRoleAttr === void 0 ? (_reportPossibleCrUseOfFormatCardRoleAttr({
              error: Error()
            }), FormatCardRoleAttr) : FormatCardRoleAttr)(role.RoleType, _this.Item.ItemEffect2);

            for (var attr of attrList) {
              if (_this.attrIconInfo[attr.id]) {
                _this.collectAttrCont.active = true;

                var _url = path.join(_crd && folder_item === void 0 ? (_reportPossibleCrUseOffolder_item({
                  error: Error()
                }), folder_item) : folder_item, _this.attrIconInfo[attr.id], "spriteFrame");

                (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
                  error: Error()
                }), ResMgr) : ResMgr).LoadResAbSub(_url, SpriteFrame, res => {
                  _this.collectAttrIcon.spriteFrame = res;
                });
                _this.collectAttrValLab.string = (_crd && formatNumber === void 0 ? (_reportPossibleCrUseOfformatNumber({
                  error: Error()
...
//# sourceMappingURL=20a86a825677301bf17fc14ccd8f59451db2b782.js.map