System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, path, Sprite, SpriteFrame, CfgMgr, Panel, VList, PlayerData, DateUtils, proto, Req, Route, folder_icon, ResMgr, CardGroupCoverItem, Session, EventMgr, Evt_SeasonFightLog, SectionBattleLogItem, SeasonFightLogCardItem, SeasonFightLogPanel, _crd;
  ...
  function _reportPossibleCrUseOfSectionBattleLogItem(extras) {
    _reporterNs.report("SectionBattleLogItem", "./SectionBattleLogItem", _context.meta, extras);
  }

  function _reportPossibleCrUseOfSeasonFightLogCardItem(extras) {
    _reporterNs.report("SeasonFightLogCardItem", "./SeasonFightLogCardItem", _context.meta, extras);
  }

  _export("SeasonFightLogPanel", void 0);
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SectionBattleLogItem = _unresolved_12.SectionBattleLogItem;
    }, function (_unresolved_13) {
      SeasonFightLogCardItem = _unresolved_13.SeasonFightLogCardItem;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "80062W5BxZC+72ix2a3J+Xz", "SeasonFightLogPanel", undefined);

      __checkObsolete__(['Node', 'Label', 'path', 'Sprite', 'SpriteFrame']);

      _export("SeasonFightLogPanel", SeasonFightLogPanel = class SeasonFightLogPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        error: Error()
      }), Panel) : Panel) {
        constructor() {
          super(...arguments);
          this.prefab = "prefabs/season/SeasonFightLogPanel";
          this.logList = void 0;
          this.nameImg = void 0;
          this.timeLab = void 0;
        ...
        onShow() {
          this.onLogUpdate();
          var sendData = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        updateCellLog(cell, cellInfo) {
          ...
          var logItem = cell.getComponent(_crd && SectionBattleLogItem === void 0 ? (_reportPossibleCrUseOfSectionBattleLogItem({
            error: Error()
          }), SectionBattleLogItem) : SectionBattleLogItem) || cell.addComponent(_crd && SectionBattleLogItem === void 0 ? (_reportPossibleCrUseOfSectionBattleLogItem({
            error: Error()
          }), SectionBattleLogItem) : SectionBattleLogItem);
        ...
        updateCellCardA(cell, cellInfo) {
          ...
          var logCardItem = cell.getComponent(_crd && SeasonFightLogCardItem === void 0 ? (_reportPossibleCrUseOfSeasonFightLogCardItem({
            error: Error()
          }), SeasonFightLogCardItem) : SeasonFightLogCardItem) || cell.addComponent(_crd && SeasonFightLogCardItem === void 0 ? (_reportPossibleCrUseOfSeasonFightLogCardItem({
            error: Error()
          }), SeasonFightLogCardItem) : SeasonFightLogCardItem);
        ...
        selectLog(data) {
          ...
          (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
          }), ResMgr) : ResMgr).LoadResAbSub(path.join("sheets/season", imgStr, "spriteFrame"), SpriteFrame, res => {
...
//# sourceMappingURL=7f28e369bafed6eb1d25d97d34b8922a294b02b8.js.map