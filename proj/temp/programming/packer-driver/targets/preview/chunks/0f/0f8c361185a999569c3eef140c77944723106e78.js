    ...
    execute: function () {
      ...
      _export("CardsPanel", CardsPanel = class CardsPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateCardItem(cell, cellInfo) {
          var card = cell.getChildByName("Cards").getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
            error: Error()
        ...
        onSelectCard(cell, cellInfo, lastCell, lastInfo) {
          if (cell && cell.getChildByName("Cards")) {
            var cards = cell.getChildByName("Cards").getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card);
        ...
        setCardGary(data, is_gray) {
          ...
          for (var iterator of this.Content.children) {
            var item = iterator.getChildByName("Cards").getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card);
        ...
        setCardState(data, is_select, isUpdate, isDle) {
          ...
          for (var index = 0; index < content.length; index++) {
            ...
            var card = element.getChildByName("Cards").getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card);
        ...
        CreaterCardGroupAnmition() {
          ...
          if (this.is_open_add_card_group) {
            ...
            spine.setCompleteListener(() => {
              ...
              this.old_selects = [];
              var old_card_list = JSON.parse(JSON.stringify(this.selects));
              ...
              var _loop2 = function _loop2() {
                var element = _this6.selects[index];
                var is_add = old_card_list.findIndex(card_data => card_data.id == element.id);

                if (is_add == -1) {
                  _this6.setCardState(element, true);

                  _this6.setCardGary(element, true);
                }
              };
              ...
              var _loop3 = function _loop3() {
                var element = old_card_list[_index];

                var is_del = _this6.selects.findIndex(card_data => card_data.id == element.id);

                if (is_del == -1) {
                  _this6.setCardState(element, false);

                  _this6.setCardGary(element, false);
                }
              };

              for (var _index = 0; _index < old_card_list.length; _index++) {
                _loop3();
              }
            });
          } else {
            ...
            var card_list = JSON.parse(JSON.stringify(this.selects));
