  ...
  return {
    ...
    execute: function () {
      ...
      _export("TaskModule", TaskModule = class TaskModule {
        ...
        onTaskChange(data) {
          var task_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
          }), Ret) : Ret).PlayerTasksChangedPush.decode(data); // console.log("任务推送", task_data)

          for (var iterator of task_data.list) {
        ...
        onRefreshDailyTaskPush(data) {
          ...
          var change = task_data.change ? task_data.change : 0;
          var changeBefore = task_data.changeBefore ? task_data.changeBefore : 0;
          (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
