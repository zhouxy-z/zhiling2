  ...
  return {
    ...
    execute: function () {
      ...
      _export("UserEditInfoPanel", UserEditInfoPanel = class UserEditInfoPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        onBtnClick(btn) {
          var inputStr = this.editBox.string;
          ...
          if (this.curType == EditType.Edit_Name) {
            ...
            var qqReg = new RegExp(/^[1-9]\d{4,9}$/);
        ...
        updateView() {
          ...
          if (this.curType == EditType.Edit_Name) {
            ...
            var myWeChat = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
              error: Error()
            ...
            var myQQ = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
              error: Error()
            }), LocalStorage) : LocalStorage).GetPlayerData("Player_" + (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
