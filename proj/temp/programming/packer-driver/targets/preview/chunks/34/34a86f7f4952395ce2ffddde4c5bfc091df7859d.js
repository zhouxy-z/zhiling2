  ...
  return {
    ...
    execute: function () {
      ...
      _export("OpenBoxPanel1", OpenBoxPanel1 = class OpenBoxPanel1 extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush() {
          this.itemData = arguments.length <= 0 ? undefined : arguments[0]; // this.itemData = CfgMgr.Getitem(1202)
          ...
          var is_select = this.BoxData.Boxtype == (_crd && BoxType === void 0 ? (_reportPossibleCrUseOfBoxType({
            error: Error()
          ...
          var rewardDataType = this.BoxData.Types;
          var rewardData = this.BoxData.Items;
          var rewardDataNum = this.BoxData.ItemsNum;
          var rewardCount = this.BoxData.Items.length < 8 ? this.BoxData.Items.length : 8;
          ...
          for (var index = 0; index < page_num; index++) {
            ...
            for (var i = 0; i < rewardCount; i++) {
              ...
              var num = rewardDataNum[i + index * rewardCount] ? rewardDataNum[i + index * rewardCount] : 1;
          ...
          for (var k = 0; k < page_num; k++) {
            var item = instantiate(this.openBoxItem);
        ...
        getSelect(data) {
          ...
          this.lbl_tips.string = "选择获得以下道具" + this.selectItem.length + "/" + this.BoxData.RewardNum;
          var isClick = this.selectItem.length == this.BoxData.RewardNum;
        ...
        onOk() {
          ...
          if (this.curSelectCount >= 2 && this.BoxData.Text && this.BoxData.Text != "") {
            var id = this.BoxData.Items[this.selectItem[0]]; // let lbl = CfgMgr.GetRewardRoleById(id).RoleName
