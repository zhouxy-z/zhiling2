    ...
    execute: function () {
      ...
      _export("ItemUtil", ItemUtil = class ItemUtil {
        ...
        static GetSThingList(itemTypeList, itemIdList, itemNumList) {
          ...
          for (var index = 0; index < itemTypeList.length; index++) {
        ...
        static CreateThing(itemType, itemId, itemNum) {
          if (itemId === void 0) {
            itemId = 0;
          }
          ...
          var thingList = this.GetSThingList(_itemType, [itemId], [itemNum]);
        ...
        static CheckItemIsHave(itemType, itemNum, itemId) {
          if (itemId === void 0) {
            itemId = 0;
          }
        ...
        static CheckThingConsumes(itemTypeList, itemIdList, itemNumList, isShowTips, isShowGetWay, tipsStr) {
          if (isShowTips === void 0) {
            isShowTips = false;
          }

          if (isShowGetWay === void 0) {
            isShowGetWay = false;
          }
          ...
          if (!itemTypeList) {
            ...
            for (var index = 0; index < itemIdList.length; index++) {
              type_list.push("item");
            }
          ...
          for (var _index = 0; _index < itemTypeList.length; _index++) {
            itemType = is_number_str ? itemTypeList[_index] : this.SthingType[itemTypeList[_index]];
            itemId = itemIdList[_index];
            itemNum = itemNumList[_index];
            haveNum = 0;
            itemName = "";
            ...
            switch (itemType) {
              case (_crd && ThingTypeName === void 0 ? (_reportPossibleCrUseOfThingTypeName({
                ...
                if (stdItem.Itemtpye == (_crd && ItemType === void 0 ? (_reportPossibleCrUseOfItemType({
                  ...
                  itemNum = itemNumList[_index] / 10000;
                }
