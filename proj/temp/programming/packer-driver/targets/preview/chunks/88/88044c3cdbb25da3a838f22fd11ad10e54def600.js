System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfCardTest(extras) {
    _reporterNs.report("CardTest", "./CardTest", _context.meta, extras);
  }

  _export("CardsPanelTest", void 0);
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CardSotrType1 = _unresolved_7.CardSotrType1;
      CardSotrType2 = _unresolved_7.CardSotrType2;
      CfgMgr = _unresolved_7.CfgMgr;
      skillType = _unresolved_7.skillType;
    }, function (_unresolved_8) {
      CardGroupItem = _unresolved_8.CardGroupItem;
    }, function (_unresolved_9) {
      CardInfoStateType = _unresolved_9.CardInfoStateType;
    }, function (_unresolved_10) {
      Second = _unresolved_10.Second;
    }, function (_unresolved_11) {
      proto = _unresolved_11.default;
      Req = _unresolved_11.Req;
      Ret = _unresolved_11.Ret;
      Route = _unresolved_11.Route;
    }, function (_unresolved_12) {
      CardsSortOrFiltrate = _unresolved_12.CardsSortOrFiltrate;
    }, function (_unresolved_13) {
      CardsGroupSetting = _unresolved_13.CardsGroupSetting;
    }, function (_unresolved_14) {
      Goto = _unresolved_14.Goto;
    }, function (_unresolved_15) {
      Tips = _unresolved_15.Tips;
    }, function (_unresolved_16) {
      MsgPanel = _unresolved_16.MsgPanel;
    }, function (_unresolved_17) {
      Tips2 = _unresolved_17.Tips2;
    }, function (_unresolved_18) {
      VList = _unresolved_18.VList;
    }, function (_unresolved_19) {
      CardTest = _unresolved_19.CardTest;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "460a4AbajVOmIUKjjQXmf3y", "CardsPanelTest", undefined);

      __checkObsolete__(['Button', 'EditBox', 'EventTouch', 'Input', 'Label', 'Layout', 'Node', 'ScrollView', 'Toggle', 'UITransform', 'Vec3', 'Widget', 'instantiate', 'js', 'size', 'sp', 'view']);
      ...
      _export("CardsPanelTest", CardsPanelTest = class CardsPanelTest extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        error: Error()
      }), Panel) : Panel) {
        constructor() {
          super(...arguments);
          this.prefab = "prefabs/cards/CardsPanelTest";
        ...
        onLoad() {
          ...
          this.illustratedScrollView = this.find("illustratedScrollView", _crd && AutoScroller === void 0 ? (_reportPossibleCrUseOfAutoScroller({
            error: Error()
          }), AutoScroller) : AutoScroller);
        ...
        flush(data) {
          var is_show_head_node = this.card_group_setting.node.getChildByName("ornamentNode").active;
        ...
        onPage(t) {
          ...
          if (page == 0) {
            ...
            var cfg_card_list = (_crd && CardsSortOrFiltrate === void 0 ? (_reportPossibleCrUseOfCardsSortOrFiltrate({
              error: Error()
        ...
        setHaveCardGroup(data) {
          ...
          var getdeckcards = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
        ...
        updatePanel() {
          ...
          var size_1 = this.cardGroupScrollView.getComponent(UITransform).contentSize;
          var size_2 = this.addCardNode.getComponent(UITransform).contentSize;
          var size_3 = this.is_open_add_card_group ? size_2 : size_1;
          ...
          this.Content.children.forEach(item => {
            if (item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest)) {
              item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
                error: Error()
              }), CardTest) : CardTest).setSelect(false);
            }
          });
          var height = this.scroller.getComponent(UITransform).contentSize.height;
          var panel_width = view.getVisibleSize().width;
          var paddingLeft = 30;
          var paddingRight = 0;
          var right_width = size_3.width + paddingLeft + paddingRight;
          var max_width = panel_width - right_width;
          ...
          var item_width = this.clone_item.getComponent(UITransform).contentSize.width; //最大放几个卡牌

          var num = Math.floor(max_width / item_width); //总剩余的间隙

          var yu = max_width % item_width; //最大间隙

          var jianju = Math.floor(yu / (num - 1)); //最小间隙15
        ...
        updateAllCardGroup() {
          ...
          if ((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            ...
            //已领取新手卡组
            for (var index = 0; index < (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            ...
            //未领取新手卡组加入一个初始卡组
            var initCardGroupCfg = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).Get("Noob_CardGroup")[0];
            var initCardGroup = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
        ...
        updateCardItem(cell, cellInfo) {
          var card = cell.getChildByName("CardsTest").getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest) || cell.getChildByName("CardsTest").addComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
          card.setIsShowUpEffect(true);
          cell.getChildByPath("CardsTest/cardNode/select").active = cellInfo.isSelect;
          var data = this.data_list[cellInfo.index];
          card.SetData(data);
          ...
          if (data && data.id == "") {
            ...
            for (var iterator of this.selects) {
              var select_card_cfg = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
        ...
        updateCardGroupCardItem(item, data, index) {
          var card = item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
          if (!card) card = item.addComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
          card.SetData(data);
        ...
        onSelectCard(cell, cellInfo, lastCell, lastInfo) {
          var cards = cell.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
          var data = cards.getData();
          ...
          if (data) {
            if (this.is_open_add_card_group) {
              ...
              var type = (_crd && CardInfoStateType === void 0 ? (_reportPossibleCrUseOfCardInfoStateType({
                error: Error()
              ...
              (_crd && Goto === void 0 ? (_reportPossibleCrUseOfGoto({
                ...
                error: Error()
              }), CardInfoStateType) : CardInfoStateType).Creator, _callBack.bind(this));
            }
          }
        }

        addCardsGroup() {
          var data = this.setCurCardGroupCardList(this.selects);
          ;
        ...
        onCardGroupSelect(index, item) {
          ...
          if (typeof data == "string") {
            this.updatePanel();
            var card_data = this.setCurCardGroupCardList([]);
        ...
        updateCardsGroupCardData(data) {
          ...
          list.sort((a, b) => {
            var a_data = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).GetCard(a.cardId);
            var b_data = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
          ...
          for (var index = 0; index < this.selects.length; index++) {
            var _element = this.selects[index];
            this.setCardState(_element, true);
            this.setCardGary(_element, true);
          }

          var data_list = this.setCurCardGroupCardList(list);
        ...
        setCardGary(data, is_gray) {
          ...
          for (var iterator of this.Content.children) {
            var item = iterator.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest);
            var card_data = item.getData();
        ...
        setCurCardGroupCardList(list) {
          ...
          for (var index = 0; index < 12; index++) {
            var element = list[index] ? list[index] : null;
        ...
        onSelectCardGroupCard(index, item) {
          var cards = item.getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
            error: Error()
          }), CardTest) : CardTest);
          var is_add = item.getChildByName("add").active;
        ...
        setCardState(data, is_select, isUpdate, isDle) {
          if (is_select === void 0) {
            is_select = null;
          }

          var content = this.Content.children;
          var delete_node;

          for (var index = 0; index < content.length; index++) {
            var element = content[index];
            var card = element.getChildByName("CardsTest").getComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest);
            if (!card) card = element.getChildByName("CardsTest").addComponent(_crd && CardTest === void 0 ? (_reportPossibleCrUseOfCardTest({
              error: Error()
            }), CardTest) : CardTest);
        ...
        onClick(btn) {
          ...
          switch (name) {
            case "filtrateBtn":
              var is_open = this.filtrateBtn.node.getChildByName("open").active;
            ...
            case "upOrDown":
              ...
              var y = this.sort_type_1 == (_crd && CardSotrType1 === void 0 ? (_reportPossibleCrUseOfCardSotrType({
                error: Error()
          ...
          switch (index) {
            case MoreType.del_card:
              var callBack = () => {
                ...
                var delete_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
                  error: Error()
        ...
        onReqCreateCardGroup() {
          ...
          var cfg_logic = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).GetLogic("InitDeck");
          var head_id = cfg_logic.HeadID;
          var card_back_id = cfg_logic.BackpackerID;

          if (this.add_or_change) {
            var add = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
              error: Error()
            ...
            (_crd && Session === void 0 ? (_reportPossibleCrUseOfSession({
              ...
              error: Error()
            }), Route) : Route)["logic.protocol.adddeck"], add, this.onadddeck);
          }
        }
        /**修改后保存卡组 */
          ...
          if (this.isCanAdd) {
            ...
            if (is_change_name || is_change_card) {
              ...
              if (is_change_name && !is_change_card) {
                ...
                for (var _iterator of this.selects) {
                  id_list.push(_iterator.id);
                }

                var _data = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                  error: Error()
                }), PlayerData) : PlayerData).getCardGroupDataById((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                  error: Error()
                }), PlayerData) : PlayerData).cur_id);

                _data.name = this.groupNameEditBox.string;
                var send_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
                  error: Error()
                }), Req) : Req)["logic.protocol.setdeckcards"]();
                send_data.attrs = _data;
        ...
        setCardSort() {// this.card_list = CardsSortOrFiltrate.setCardSort(this.sort_type_1, this.sort_type_2, this.card_list)
          // this.setCardsData(this.card_list)
        } //——————————————————————————————————————————————————————————————————————筛选相关————————————————————————————————————————————————————————
        //搜索后的卡牌
        ...
        skillSearch() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this3.selectSkillType = (_crd && skillType === void 0 ? (_reportPossibleCrUseOfskillType({
              error: Error()
            }), skillType) : skillType).undefined;
            var data = (_crd && CardsSortOrFiltrate === void 0 ? (_reportPossibleCrUseOfCardsSortOrFiltrate({
              error: Error()
            }), CardsSortOrFiltrate) : CardsSortOrFiltrate).skillSearch(_this3.editBox, _this3.skillEffNode, _this3.selectSkillList, _this3.selectSkillType, _this3.costType, _this3.showType);
            _this3.selectSkillList = data[0];
            _this3.selectSkillType = data[1];

            _this3.setCardsData(_this3.selectSkillList);

            _this3.card_list = _this3.selectSkillList;
          })();
        } //筛选能量消耗的卡牌
        ...
        costSearch() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var data = (_crd && CardsSortOrFiltrate === void 0 ? (_reportPossibleCrUseOfCardsSortOrFiltrate({
              error: Error()
            }), CardsSortOrFiltrate) : CardsSortOrFiltrate).costSearch(_this4.editBox, _this4.costNode, _this4.costTypeList, _this4.selectSkillType, _this4.costType, _this4.showType);
            _this4.costTypeList = data[0];
            _this4.costType = data[1];

            _this4.setCardsData(_this4.costTypeList);

            _this4.card_list = _this4.costTypeList;
          })();
        } //筛选自定义展示的卡牌
        ...
        showSearch() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this5.showType = false;
            var data = (_crd && CardsSortOrFiltrate === void 0 ? (_reportPossibleCrUseOfCardsSortOrFiltrate({
              error: Error()
            }), CardsSortOrFiltrate) : CardsSortOrFiltrate).showSearch(_this5.editBox, _this5.diyNode, _this5.showTypeList, _this5.selectSkillType, _this5.costType, _this5.showType);
            _this5.showTypeList = data[0];
            _this5.showType = data[1];

            _this5.setCardsData(_this5.showTypeList);

            _this5.card_list = _this5.showTypeList;
          })();
        } //----------------------------------特殊处理的协议------------------------------
        ...
        onadddeck(data) {
          var setData = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
          ...
          if (setData.res.code == 200) {
            ...
            (_crd && MsgPanel === void 0 ? (_reportPossibleCrUseOfMsgPanel({
              error: Error()
            }), MsgPanel) : MsgPanel).Show("设置卡组失败 code" + setData.res.code);
          }
        }
        /**生成卡组动画展示 */
...
//# sourceMappingURL=88044c3cdbb25da3a838f22fd11ad10e54def600.js.map