      ...
      _export("ShopPanel1", ShopPanel1 = class ShopPanel1 extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(shopGroupId) {
          ...
          return _asyncToGenerator(function* () {
            _this.curTabIndex = -1;
            var showShopList = [];
            var defShowList = _this.ShopGroupInfo[shopGroupId];
            var stdShopGroup;
            var stdShopIndex;

            for (var index = 0; index < defShowList.length; index++) {
            ...
            _this.tabDatas = showShopList;

            _this.tabBtnList.UpdateDatas(_this.tabDatas);

            _this.tabBtnList.SelectFirst(0);
          })();
        }
        ...
        updateHave() {
          var haveItems = [];
          var tabData = this.tabDatas[this.curTabIndex];
          var stdShopIndex = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
        ...
        updateTabSelect() {
          ...
          for (var _key in this.shopPageInfo) {
            shopType = Number(_key);
            shopBasePage = this.shopPageInfo[_key];
        ...
        updateHaveItem(item, data) {
          var consumeItem = item.getComponent(_crd && ConsumeItem === void 0 ? (_reportPossibleCrUseOfConsumeItem({
            error: Error()
        ...
        updateTabBtnItem(item, data, index) {
          var tabBtnItem = item.getComponent(_crd && ShopTabBtnItem === void 0 ? (_reportPossibleCrUseOfShopTabBtnItem({
            error: Error()
          ...
          var select = item.getChildByName("selectCont");
        ...
        resetSelect() {
          ...
          for (var index = 0; index < this.tabBtnList.children.length; index++) {
