System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, DragDropMgr, DragDropGrid, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, DragDropExample;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1fc58q9G6tPYaTv7JAVxhFV", "DragDropExample", undefined);
      ...
      _export("DragDropExample", DragDropExample = (_dec = ccclass('DragDropExample'), _dec2 = property({
        ...
        start() {
          ...
          for (var index = 0; index < this.grid1.children.length; index++) {
            var element = this.grid1.children[index];
            var com = element.addComponent(_crd && DragDropGrid === void 0 ? (_reportPossibleCrUseOfDragDropGrid({
              error: Error()
          ...
          for (var _index = 0; _index < this.grid2.children.length; _index++) {
            var _element = this.grid2.children[_index];

            var _com = _element.addComponent(_crd && DragDropGrid === void 0 ? (_reportPossibleCrUseOfDragDropGrid({
              error: Error()
            }), DragDropGrid) : DragDropGrid);

            (_crd && DragDropMgr === void 0 ? (_reportPossibleCrUseOfDragDropMgr({
              error: Error()
            }), DragDropMgr) : DragDropMgr).addDragNode(_com.node);
            (_crd && DragDropMgr === void 0 ? (_reportPossibleCrUseOfDragDropMgr({
              error: Error()
            }), DragDropMgr) : DragDropMgr).addDropNode(_com.node);
        ...
        creatDragNode(node) {
          var dragNode = node.getChildByName("icon");
          var dragData = {
            dragNode: dragNode,
...
//# sourceMappingURL=6c98f4bc313db340b192658313e0a9efb93b8970.js.map