    ...
    execute: function () {
      ...
      _export("CardsGroupCheckPanel", CardsGroupCheckPanel = class CardsGroupCheckPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateCardGroupItem(item, data) {
          var card_name = item.getChildByName("name").getComponent(Label);
          card_name.string = data.name;
          var card_id = item.getChildByName("id").getComponent(Label);
        ...
        onSetDefault() {
          var set = new (_crd && Protocol === void 0 ? (_reportPossibleCrUseOfProtocol({
            error: Error()
