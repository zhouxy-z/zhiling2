  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShopRefreshPanel", ShopRefreshPanel = class ShopRefreshPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(stdShop, shopId) {
          var _this = this;

          return _asyncToGenerator(function* () {
            _this.stdShop = stdShop;
            _this.shopId = shopId; // let things:SThing[] = ItemUtil.GetSThingList(this.stdShop.RefreshThingType, this.stdShop.RefreshThingId, this.stdShop.RefreshThingCount);
            // let itemName:string = "";
