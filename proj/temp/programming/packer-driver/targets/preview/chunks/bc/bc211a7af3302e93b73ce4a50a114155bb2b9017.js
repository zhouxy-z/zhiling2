      ...
      _export("CardGroupItem", CardGroupItem = class CardGroupItem extends Component {
        ...
        SetData(data) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.warning.active = data.size < 12;
            var url = data.size < 12 ? path.join("sheets/default/卡组红", "spriteFrame") : path.join("sheets/default/卡组蓝", "spriteFrame");
            (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).LoadResAbSub(url, SpriteFrame, res => {
              _this.bg.spriteFrame = res;
            });
            _this.useLab.active = data.id == (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
