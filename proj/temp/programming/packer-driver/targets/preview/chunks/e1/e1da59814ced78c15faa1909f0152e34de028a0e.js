      ...
      _export("App", App = class App {
        constructor() {
          ...
          if (DEV && HTML5) {
            ...
            window['resetGuide'] = function () {
              var cfgs = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
            ...
            window['testStep'] = function (url, msg, angle, modal, offset, msgAngle, msgOffset, msgSize, duration) {
              if (msg === void 0) {
                msg = "";
              }
              ...
              var btn = find(url);
              if (!btn) return;
              var pointer = (_crd && PointTo === void 0 ? (_reportPossibleCrUseOfPointTo({
                error: Error()
            ...
            window['testCondition'] = function (conditionId) {
            ...
            window['cleanGuide'] = function () {
              var guides = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
                error: Error()
              }), CfgMgr) : CfgMgr).Get('guide');
        ...
        init() {
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
            }), CfgMgr) : CfgMgr).load();
            yield (_crd && FightUI === void 0 ? (_reportPossibleCrUseOfFightUI({
              error: Error()
