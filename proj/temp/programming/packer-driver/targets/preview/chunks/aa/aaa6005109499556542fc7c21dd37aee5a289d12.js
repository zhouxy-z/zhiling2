      ...
      _export("CardUpgradePanel", CardUpgradePanel = class CardUpgradePanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        updateShow() {
          ...
          if (!nextUpgrade) {
            ...
            var nextQual = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
              error: Error()
        ...
        initHaveItem() {
          ...
          for (var index = 0; index < this.haveItemCont.children.length; index++) {
        ...
        updateCost(itemIds, itemNums) {
          ...
          for (var index = 0; index < this.costCont.children.length; index++) {
        ...
        initAwardCard() {
          ...
          for (var _index = 0; _index < awardCardId.length; _index++) {
            var cardDatas = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).GetCardDataByCfgId(awardCardId[_index]);
            ...
            if (cardDatas.length) {
              ...
              var cardData = (_crd && base === void 0 ? (_reportPossibleCrUseOfbase({
                error: Error()
        ...
        initCardClass(id, cardId) {
          ...
          for (var std of cards) {
            ...
            if (!isGet) {
              var cardClassData = (_crd && base === void 0 ? (_reportPossibleCrUseOfbase({
                error: Error()
              }), base) : base).BattleCard.create();
        ...
        updateCardCalssCell(cell, cellInfo) {
          var cellCom = cell.getComponent(_crd && CardTitleItem === void 0 ? (_reportPossibleCrUseOfCardTitleItem({
            error: Error()
        ...
        onShowNotCardTips(node) {
          var showPos = node.worldPosition.clone();
