System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Event, EventTouch, Input, Layout, Node, ScrollView, UITransform, _decorator, instantiate, Second, _dec, _dec2, _dec3, _class, _crd, ccclass, property, disallowMultiple, requireComponent, AutoScroller;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "05ebda2b1xG+L5cUmmJHqGE", "AutoScroller", undefined);

      __checkObsolete__(['Component', 'Event', 'EventTouch', 'Input', 'Layout', 'Node', 'NodeEventType', 'ScrollView', 'Size', 'UITransform', 'Vec2', 'Vec3', '_decorator', 'instantiate', 'v2', 'v3']);
      ...
      _export("AutoScroller", AutoScroller = (_dec = ccclass('AutoScroller'), _dec2 = disallowMultiple(true), _dec3 = requireComponent(ScrollView), _dec(_class = _dec2(_class = _dec3(_class = class AutoScroller extends Component {
        ...
        getGridCol(itemW) {
          var col = Math.floor(this.contentW / itemW);

          while (col > 0) {
            var tempW = col * (itemW + this.spaceX) - this.spaceX;
        ...
        getItem(index) {
          ...
          if (this.itemPool.length) {
            var _item2 = this.itemPool.pop();

            if (!_item2.hasEventListener(Input.EventType.TOUCH_END, this.onSelect, this)) {
              _item2.on(Input.EventType.TOUCH_END, this.onSelect, this);
            }
          ...
          if (this.original) {
            ...
            var _item3 = instantiate(this.original);

            _item3.on(Input.EventType.TOUCH_END, this.onSelect, this);
        ...
        flush(reset) {
          ...
          if (this.type == Layout.Type.VERTICAL) {
            ...
            for (var i = start; i <= end; i++) {
              ...
              var _item4 = this.getItem(i);

              if (_item4['$$index'] != i || reset) (_this$updateItem2 = this.updateItem) == null || _this$updateItem2.call(this, _item4, this.datas[i], i);
              _item4['$$index'] = i;
              this.scroller.content.addChild(_item4);
              this.layout(_item4, 0, i);
              views[i + ''] = _item4;
              this.showing[i + ''] = _item4;
            }
          } else if (this.type == Layout.Type.HORIZONTAL) {
            ...
            for (var _i = _start; _i <= _end; _i++) {
              ...
              var _item5 = this.getItem(_i);

              if (_item5['$$index'] != _i || reset) (_this$updateItem3 = this.updateItem) == null || _this$updateItem3.call(this, _item5, this.datas[_i], _i);
              _item5['$$index'] = _i;
              this.scroller.content.addChild(_item5);
              this.layout(_item5, _i, 0);
              views[_i + ''] = _item5;
              this.showing[_i + ''] = _item5;
            }
            ...
            for (var y = _start2; y <= _end2; y++) {
              for (var x = 0; x < col; x++) {
                ...
                var _item6 = this.getItem(_i2);

                if (_item6['$$index'] != _i2 || reset) (_this$updateItem4 = this.updateItem) == null || _this$updateItem4.call(this, _item6, this.datas[_i2], _i2);
                _item6['$$index'] = _i2;
                this.scroller.content.addChild(_item6);
                this.layout(_item6, x, y);
                views[_i2 + ''] = _item6;
                this.showing[_i2 + ''] = _item6;
                _i2++;
              }
        ...
        ScrollToIndex(index) {
          ...
          if (this.type == Layout.Type.VERTICAL) {
            ...
            for (var i = start; i <= end; i++) {
              ...
              var _item7 = this.getItem(i);

              if (_item7['$$index'] != i) (_this$updateItem5 = this.updateItem) == null || _this$updateItem5.call(this, _item7, this.datas[i], i);
              _item7['$$index'] = i;
              this.scroller.content.addChild(_item7);
              this.layout(_item7, 0, i);
              views[i + ''] = _item7;
              this.showing[i + ''] = _item7;
            }
...
//# sourceMappingURL=6950a9a6452fb8f8f52d369dcb545b77846ff2a3.js.map