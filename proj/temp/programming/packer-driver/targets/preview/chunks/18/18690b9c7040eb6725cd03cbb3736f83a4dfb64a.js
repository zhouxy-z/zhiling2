System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Label, path, Sprite, SpriteFrame, proto, folder_icon, ResMgr, CfgMgr, PlayerData, DateUtils, SectionBattleLogItem, _crd;
  ...
  _export("SectionBattleLogItem", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "cee7amntkRHBIVAgURkfZGc", "SectionBattleLogItem", undefined);

      __checkObsolete__(['Component', 'Label', 'path', 'Sprite', 'SpriteFrame']);

      _export("SectionBattleLogItem", SectionBattleLogItem = class SectionBattleLogItem extends Component {
        constructor() {
          super(...arguments);
          this.head = void 0;
        ...
        updateShow() {
          ...
          var playerData = this.data.battlePlayers[(_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
...
//# sourceMappingURL=18690b9c7040eb6725cd03cbb3736f83a4dfb64a.js.map