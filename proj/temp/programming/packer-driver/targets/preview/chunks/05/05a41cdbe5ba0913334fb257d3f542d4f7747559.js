System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Label, path, sp, Sprite, SpriteFrame, CfgMgr, card_quality, folder_icon, ResMgr, Utils, EventMgr, Evt_Card_Chage, Evt_Item_Change, PlayerData, Card, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4efece55JpD45pswJ4tMBEL", "Card", undefined);
      ...
      _export("Card", Card = class Card extends Component {
        ...
        SetData(data) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (std.EthnicType) {
              _this.camp.spriteFrame = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
                error: Error()
              }), ResMgr) : ResMgr).LoadResAbSub(path.join(_crd && folder_icon === void 0 ? (_reportPossibleCrUseOffolder_icon({
                error: Error()
              }), folder_icon) : folder_icon, "camp/" + std.EthnicType, "spriteFrame"), SpriteFrame);
            }

            _this.camp.node.active = std.EthnicType != 0;

            if (std.ProfessionType) {
              _this.job.spriteFrame = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
                error: Error()
              }), ResMgr) : ResMgr).LoadResAbSub(path.join(_crd && folder_icon === void 0 ? (_reportPossibleCrUseOffolder_icon({
                error: Error()
              }), folder_icon) : folder_icon, "job/" + std.ProfessionType, "spriteFrame"), SpriteFrame);
            }

            _this.job.node.active = std.ProfessionType != 0;

            _this.updateUpgradeState();
          })();
        }

        setIsShowUpEffect(bool) {
        ...
        setShowAdd(bool, callBack) {
          ...
          return _asyncToGenerator(function* () {
            if (!_this5.hasLoad) yield _this5.loadSub;
            _this5.add.active = bool;
          })();
        }
...
//# sourceMappingURL=05a41cdbe5ba0913334fb257d3f542d4f7747559.js.map