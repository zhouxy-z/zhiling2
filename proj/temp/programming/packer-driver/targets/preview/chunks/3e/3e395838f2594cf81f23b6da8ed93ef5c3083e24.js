    ...
    execute: function () {
      ...
      _export("Snapshot", Snapshot = class Snapshot extends Component {
        ...
        static Add(targetNode) {
          var layer = 4;
          var oldLayer = targetNode.layer;
          targetNode['$$old_layer'] = oldLayer;
          targetNode.layer = targetNode.layer | layer;
          var results = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          if (this.renderMap.has(targetNode)) {
            var _obj = this.renderMap.get(targetNode);

            return _obj.spriteNode;
          }
          ...
          if (oldLayer & Layers.Enum['SCENE']) {
            ...
            if (!obj) {
              ...
              _img.layer = Layers.Enum.DEFAULT;

              _img.addComponent(Sprite);
          ...
          (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var comp = child.getComponent(Sprite) || child.getComponent(sp.Skeleton);
        ...
        static Remove(targetNode) {
          if (!targetNode) {
            ...
            var obj = this.renderMap.get(targetNode);
