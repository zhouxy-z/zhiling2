      ...
      _export("CardsMode", CardsMode = class CardsMode {
        ...
        onSetHasCardGroupAttrs(setData) {
          if (setData.res.code == 200) {
            ...
            var index = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
        ...
        getPlayerdecks(data) {
          var name_data_list = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        getdeckcards(data) {
          var card_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        setdeckdefault(data) {
          var set_default = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        deletedeck(data) {
          ...
          if (delete_data.res.code == 200) {
            ...
            for (var _index = 0; _index < (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).cardNameList.length; _index++) {
              var cardData = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                error: Error()
              }), PlayerData) : PlayerData).cardNameList[_index];

              if (cardData == delete_data.deckId) {
                (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
                  error: Error()
                }), PlayerData) : PlayerData).cardNameList.splice(_index, 1);
        ...
        NewAvatarPush(data) {
          var new_head = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        getavatarinfos(data) {
          var avatar_data = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        NewCardBackPush(data) {
          var new_cardBack = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
        ...
        noobcardsclaim(data) {
          var getCardData = (_crd && Ret === void 0 ? (_reportPossibleCrUseOfRet({
            error: Error()
          ...
          if (getCardData.res.code == 200) {
            ...
            for (var key in getCardData.deckInfo.cards) {
              var element = getCardData.deckInfo.cards[key];
              var thing_data = {
