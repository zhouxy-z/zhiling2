      ...
      _export("PlayerModule", PlayerModule = class PlayerModule {
        ...
        onPlayerPower(data) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this.fightChangeOff) return;
            _this.fightChangeOff = true;
            yield (_crd && Second === void 0 ? (_reportPossibleCrUseOfSecond({
              error: Error()
            }), Second) : Second)(0.1);
            _this.fightChangeOff = false;
        ...
        onUpgradeRoleRet(data) {
          var old = JSON.parse(JSON.stringify((_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).GetRoleById(data.role.id)));
          (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          }), PlayerData) : PlayerData).AddRole(data.role);
          var isUpgrade = false; //升级或突破
        ...
        update(dt) {
          ...
          if (this.tick >= 1) {
            this.tick = 0;
            var timeMap = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
            }), PlayerData) : PlayerData).CycleTimeMap;
            if (!timeMap) return;
            var now = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
              error: Error()
        ...
        showChangeInfoErrorCode(code) {
          var errorStr = this.changeBaseInfoErrorStr[code];
