      ...
      _export("Out_WaitPlayerInput", Out_WaitPlayerInput = class Out_WaitPlayerInput extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        endOp(isSucceed) {
          ...
          if (!isSucceed) {
            ...
            for (var terrainArea of terrainAreaList) {
              for (var index = 0; index < terrainArea.gridList.length; index++) {
                ...
                if (grid.cardData && grid.cardData.location == (_crd && base === void 0 ? (_reportPossibleCrUseOfbase({
                  ...
                  for (var editGrid of this.editGridList) {
                    if (editGrid.cardData.instId == grid.cardData.instId) {
                      var sourceGrid = (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
                        error: Error()
        ...
        sendRoundConfirm() {
          if (this.editCardList) {
            ...
            for (var index = 0; index < this.editCardList.length; index++) {
        ...
        chekIsCanDrag(node) {
          ...
          if (cardData.location == (_crd && base === void 0 ? (_reportPossibleCrUseOfbase({
            ...
            var tempCardData = this.editCardList[this.editCardList.length - 1];
        ...
        onDrop(dropNode, dragData) {
          ...
          if (!dropResult) {
            ...
            if (dragData.data.areaIdx < 0) {
              ...
              var area = (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
                error: Error()
        ...
        toDrop(dropNode, dragData) {
          ...
          if (battleTerrainArea) {
            ...
            var dropGrid;
            var terrainInstId = battleTerrainArea.terrainData.instId;
            var cardGrid;

            for (var _index = 0; _index < battleTerrainArea.gridList.length; _index++) {
              cardGrid = battleTerrainArea.gridList[_index];
            ...
            if (terrainInstId && dropGrid) {
              var handToTerrain = (_crd && base === void 0 ? (_reportPossibleCrUseOfbase({
                error: Error()
            ...
            if (tempCardData && tempCardData.cardInstId == dragData.data.cardData.instId) {
              ...
              var dragGrid = this.editGridList.pop();
              var _dropGrid = (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
                error: Error()
              }), battleLogicMgr) : battleLogicMgr).handGridList[dragGrid.gridIdx];

              _dropGrid.setData(dragData.data.cardData);
