    ...
    execute: function () {
      ...
      _export("DragDropExample", DragDropExample = (_dec = ccclass('DragDropExample'), _dec2 = property({
        ...
        start() {
          ...
          var node = this.grid2.children[0];

          for (var _index = 0; _index < node.children.length; _index++) {
            var _element = node.children[_index];
        ...
        onDrop(dropNode, dragData) {
          if (dropNode) {
            ...
            var icon = dragData.dragParentNode.getChildByName("icon");
        ...
        creatDragNode(node) {
          var dragAgent = this.nodePool.get() || instantiate(this.tempAgent);
          dragAgent.name = "icon";
          var icon = node.getChildByName("icon");
          var dragData = {
            dragNode: dragAgent,
