      ...
      _export("Out_DropToHand", Out_DropToHand = class Out_DropToHand extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this.scene.AddCardToHand(isPlayerA, _this.data, (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
            }), proto) : proto).base.BattleRoomCardLocation.Drop);
            if (_this.isExit) return; // this.scene.AddCardFormHeadToHand(battleDataMgr.isPlayerA(this.ownerPlayerId), this.data);
            // await Second(0.5);
