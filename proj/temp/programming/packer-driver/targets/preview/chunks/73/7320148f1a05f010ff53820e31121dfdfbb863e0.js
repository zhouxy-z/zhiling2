System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Label, path, sp, Sprite, SpriteFrame, CfgMgr, card_quality, ResMgr, Utils, EventMgr, Evt_Card_Chage, Evt_Item_Change, PlayerData, CardTest, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4167cdKbjpGIIbEzPxjOVu5", "CardTest", undefined);

      __checkObsolete__(['Component', 'Input', 'Label', 'Node', 'path', 'sp', 'Sprite', 'SpriteFrame']);

      _export("CardTest", CardTest = class CardTest extends Component {
        constructor() {
          super(...arguments);
          this.frame = void 0;
        ...
        SetData(data) {
          ...
          return _asyncToGenerator(function* () {
            ...
            console.log(_this.data.quality);

            _this.body_card.clearAnimation();

            _this.body_card.skeletonData = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).LoadResAbSub(path.join("spine", "card_0029", "card_0029"), sp.SkeletonData);
...
//# sourceMappingURL=7320148f1a05f010ff53820e31121dfdfbb863e0.js.map