System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, BattleBaseComp, battleDataMgr, battleLogicMgr, Out_PlayerPower, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c7397zaR6RHqYXoFkho8W7Y", "Out_PlayerPower", undefined);
      ...
      _export("Out_PlayerPower", Out_PlayerPower = class Out_PlayerPower extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        start() {
          var terraninGridList = (_crd && battleLogicMgr === void 0 ? (_reportPossibleCrUseOfbattleLogicMgr({
            error: Error()
          }), battleLogicMgr) : battleLogicMgr).terrainGrildList;
          var terraninGrid;

          if (this.data.playerPower && this.data.playerPower) {
            var platerPowers = this.data.playerPower;
            var platerPower;
            var isPlayerA;

            for (var key in platerPowers) {
              ...
              for (var index = 0; index < platerPower.power.length; index++) {
                var powerAttr = platerPower.power[index];
...
//# sourceMappingURL=aee78e65db570af5229b5ce355665d23c8e24c3a.js.map