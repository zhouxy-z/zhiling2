      ...
      _export("Out_NewRound", Out_NewRound = class Out_NewRound extends (_crd && BattleBaseComp === void 0 ? (_reportPossibleCrUseOfBattleBaseComp({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
              ...
              error: Error()
            }), Battle_PlayNewRoundEffect) : Battle_PlayNewRoundEffect, _this.round, (_crd && battleDataMgr === void 0 ? (_reportPossibleCrUseOfbattleDataMgr({
              error: Error()
            }), battleDataMgr) : battleDataMgr).roomData.roundMax.finalValue);
            (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
              error: Error()
              ...
              error: Error()
            }), Battle_End_Round) : Battle_End_Round, _this.onRoundEffectPlayEnd, _this);
          })();
        }
        ...
        setHandCard(cards) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this3.isExit) return;
            _this3.isInitCardEnd = true;
          })();
        }
