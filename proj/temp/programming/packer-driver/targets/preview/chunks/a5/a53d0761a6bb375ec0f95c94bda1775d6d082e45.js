      ...
      _export("FriendListPanel", FriendListPanel = class FriendListPanel extends (_crd && Panel === void 0 ? (_reportPossibleCrUseOfPanel({
        ...
        flush(maxFriendNum) {
          ...
          return _asyncToGenerator(function* () {
            _this.friendNum.string = maxFriendNum + "";
            _this.vipNum.string = "暂无";
            _this.curPage = 1; // let rights_list = CfgMgr.GetEquityCardTab(1);
        ...
        updateItem(item, data, index) {
          ...
          var player_name = item.getChildByPath("frame/player_name").getComponent(Label);
          var friendIncomeNum = item.getChildByPath("frame/friendNode/todayNode/friendIncomeNum").getComponent(Label);
          var friendAllIncomeNum = item.getChildByPath("frame/friendNode/allNode/friendAllIncomeNum").getComponent(Label);
          var friendNode = item.getChildByPath("frame/friendNode");
          var incomeNode = item.getChildByPath("frame/incomeNode"); // let rightsBtn = item.getChildByPath("frame/rightsBtn")
        ...
        SendSessionView() {
          ...
          // }
          // Session.Send(data);
          var friend_data = new (_crd && Req === void 0 ? (_reportPossibleCrUseOfReq({
            error: Error()
